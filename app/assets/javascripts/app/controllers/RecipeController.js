RecipeController.$inject = ["Flash", "$state", "$stateParams", "DataService", "ingredients", "recipe"];
function RecipeController(Flash, $state, $stateParams, DataService, ingredients, recipe) {
  var ctrl = this
